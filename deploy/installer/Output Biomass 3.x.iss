...
Source: {#BuildDir}\Landis.Extension.Output.Biomass-v3.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Output Biomass 3.x.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Output Biomass"" "; WorkingDir: {#LandisPlugInDir}
